 ...
 */
public class DropIndexStmt extends StatementBase {
   ...
   */
  public DropIndexStmt(String indexName, TableName tableName, PartitionSpec partitionSpec) {
  ...
  public TDropIndexParms toThrift() {
	  TDropIndexParms params = new TDropIndexParms();
