...
//add by liubb
struct TCreateIndexParms{
  1: required CatalogObjects.TTableName table_name
  2: required string index_name
  3: required list<string> columns
  4: required string index_type
  5: optional bool if_with_defered_rebuild
  6: optional map<string, string> index_properties
}

//add by liubb
struct TDropIndexParms{
  1: required CatalogObjects.TTableName table_name
  2: required string index_name
  3: optional list<CatalogObjects.TPartitionKeyValue> partition_spec
}
