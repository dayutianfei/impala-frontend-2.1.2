            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_spec = new ArrayList<com.cloudera.impala.thrift.TPartitionKeyValue>(_list96.size);
                for (int _i97 = 0; _i97 < _list96.size; ++_i97)
                {
                  com.cloudera.impala.thrift.TPartitionKeyValue _elem98; // required
                  _elem98 = new com.cloudera.impala.thrift.TPartitionKeyValue();
                  _elem98.read(iprot);
                  struct.partition_spec.add(_elem98);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partition_spec != null) {
        if (struct.isSetPartition_spec()) {
          oprot.writeFieldBegin(PARTITION_SPEC_FIELD_DESC);
          {
            ...
            for (com.cloudera.impala.thrift.TPartitionKeyValue _iter99 : struct.partition_spec)
            {
              _iter99.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPartition_spec()) {
        {
          ...
          for (com.cloudera.impala.thrift.TPartitionKeyValue _iter100 : struct.partition_spec)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partition_spec = new ArrayList<com.cloudera.impala.thrift.TPartitionKeyValue>(_list101.size);
          for (int _i102 = 0; _i102 < _list101.size; ++_i102)
          {
            com.cloudera.impala.thrift.TPartitionKeyValue _elem103; // required
            _elem103 = new com.cloudera.impala.thrift.TPartitionKeyValue();
            _elem103.read(iprot);
            struct.partition_spec.add(_elem103);
          }
        }
        struct.setPartition_specIsSet(true);
      }
