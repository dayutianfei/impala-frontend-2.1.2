...
public class TExprBatch implements org.apache.thrift.TBase<TExprBatch, TExprBatch._Fields>, java.io.Serializable, Cloneable {
  ...
  public TExprBatch(TExprBatch other) {
    if (other.isSetExprs()) {
      List<TExpr> __this__exprs = new ArrayList<TExpr>();
  ...
  public int compareTo(TExprBatch other) {
    ...
    TExprBatch typedOther = (TExprBatch)other;

    lastComparison = Boolean.valueOf(isSetExprs()).compareTo(typedOther.isSetExprs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExprs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.exprs, typedOther.exprs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.exprs = new ArrayList<TExpr>(_list16.size);
                for (int _i17 = 0; _i17 < _list16.size; ++_i17)
                {
                  TExpr _elem18; // required
                  _elem18 = new TExpr();
                  _elem18.read(iprot);
                  struct.exprs.add(_elem18);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TExprBatch struct) throws org.apache.thrift.TException {
      ...
      if (struct.exprs != null) {
        oprot.writeFieldBegin(EXPRS_FIELD_DESC);
        {
          ...
          for (TExpr _iter19 : struct.exprs)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TExprBatchTupleScheme extends TupleScheme<TExprBatch> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TExprBatch struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (TExpr _iter20 : struct.exprs)
        {
          _iter20.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExprBatch struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.exprs = new ArrayList<TExpr>(_list21.size);
        for (int _i22 = 0; _i22 < _list21.size; ++_i22)
        {
          TExpr _elem23; // required
          _elem23 = new TExpr();
          _elem23.read(iprot);
          struct.exprs.add(_elem23);
        }
      }
      struct.setExprsIsSet(true);
    }
