...
public class TAggregateFunction implements org.apache.thrift.TBase<TAggregateFunction, TAggregateFunction._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.SERIALIZE_FN_SYMBOL,_Fields.MERGE_FN_SYMBOL,_Fields.FINALIZE_FN_SYMBOL,_Fields.GET_VALUE_FN_SYMBOL,_Fields.REMOVE_FN_SYMBOL,_Fields.IGNORES_DISTINCT};
  ...
  public int compareTo(TAggregateFunction other) {
    ...
    TAggregateFunction typedOther = (TAggregateFunction)other;

    lastComparison = Boolean.valueOf(isSetIntermediate_type()).compareTo(typedOther.isSetIntermediate_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIntermediate_type()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.intermediate_type, typedOther.intermediate_type);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetUpdate_fn_symbol()).compareTo(typedOther.isSetUpdate_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUpdate_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.update_fn_symbol, typedOther.update_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetInit_fn_symbol()).compareTo(typedOther.isSetInit_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInit_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.init_fn_symbol, typedOther.init_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSerialize_fn_symbol()).compareTo(typedOther.isSetSerialize_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSerialize_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.serialize_fn_symbol, typedOther.serialize_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetMerge_fn_symbol()).compareTo(typedOther.isSetMerge_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMerge_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.merge_fn_symbol, typedOther.merge_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetFinalize_fn_symbol()).compareTo(typedOther.isSetFinalize_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFinalize_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.finalize_fn_symbol, typedOther.finalize_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetGet_value_fn_symbol()).compareTo(typedOther.isSetGet_value_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGet_value_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.get_value_fn_symbol, typedOther.get_value_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRemove_fn_symbol()).compareTo(typedOther.isSetRemove_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRemove_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.remove_fn_symbol, typedOther.remove_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetIgnores_distinct()).compareTo(typedOther.isSetIgnores_distinct());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIgnores_distinct()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ignores_distinct, typedOther.ignores_distinct);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
