...
public class THBaseTable implements org.apache.thrift.TBase<THBaseTable, THBaseTable._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_binary_encoded);
    if (present_binary_encoded)
      builder.append(binary_encoded);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.families = new ArrayList<String>(_list94.size);
                for (int _i95 = 0; _i95 < _list94.size; ++_i95)
                {
                  String _elem96; // required
                  _elem96 = iprot.readString();
                  struct.families.add(_elem96);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.qualifiers = new ArrayList<String>(_list97.size);
                for (int _i98 = 0; _i98 < _list97.size; ++_i98)
                {
                  String _elem99; // required
                  _elem99 = iprot.readString();
                  struct.qualifiers.add(_elem99);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.binary_encoded = new ArrayList<Boolean>(_list100.size);
                for (int _i101 = 0; _i101 < _list100.size; ++_i101)
                {
                  boolean _elem102; // required
                  _elem102 = iprot.readBool();
                  struct.binary_encoded.add(_elem102);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, THBaseTable struct) throws org.apache.thrift.TException {
      ...
      if (struct.families != null) {
        oprot.writeFieldBegin(FAMILIES_FIELD_DESC);
        {
          ...
          for (String _iter103 : struct.families)
          {
      ...
      if (struct.qualifiers != null) {
        oprot.writeFieldBegin(QUALIFIERS_FIELD_DESC);
        {
          ...
          for (String _iter104 : struct.qualifiers)
          {
      ...
      if (struct.binary_encoded != null) {
        if (struct.isSetBinary_encoded()) {
          oprot.writeFieldBegin(BINARY_ENCODED_FIELD_DESC);
          {
            ...
            for (boolean _iter105 : struct.binary_encoded)
            {
              oprot.writeBool(_iter105);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class THBaseTableTupleScheme extends TupleScheme<THBaseTable> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, THBaseTable struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.tableName);
      {
        ...
        for (String _iter106 : struct.families)
        {
      ...
      }
      {
        ...
        for (String _iter107 : struct.qualifiers)
        {
      ...
      if (struct.isSetBinary_encoded()) {
        {
          ...
          for (boolean _iter108 : struct.binary_encoded)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, THBaseTable struct) throws org.apache.thrift.TException {
      ...
      struct.setTableNameIsSet(true);
      {
        ...
        struct.families = new ArrayList<String>(_list109.size);
        for (int _i110 = 0; _i110 < _list109.size; ++_i110)
        {
          String _elem111; // required
          _elem111 = iprot.readString();
          struct.families.add(_elem111);
        }
      }
      struct.setFamiliesIsSet(true);
      {
        ...
        struct.qualifiers = new ArrayList<String>(_list112.size);
        for (int _i113 = 0; _i113 < _list112.size; ++_i113)
        {
          String _elem114; // required
          _elem114 = iprot.readString();
          struct.qualifiers.add(_elem114);
        }
      }
      struct.setQualifiersIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.binary_encoded = new ArrayList<Boolean>(_list115.size);
          for (int _i116 = 0; _i116 < _list115.size; ++_i116)
          {
            boolean _elem117; // required
            _elem117 = iprot.readBool();
            struct.binary_encoded.add(_elem117);
          }
        }
        struct.setBinary_encodedIsSet(true);
      }
