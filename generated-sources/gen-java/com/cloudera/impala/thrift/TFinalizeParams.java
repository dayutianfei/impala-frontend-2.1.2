...
public class TFinalizeParams implements org.apache.thrift.TBase<TFinalizeParams, TFinalizeParams._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.STAGING_DIR,_Fields.TABLE_ID};
  ...
  public int hashCode() {
    ...
    builder.append(present_is_overwrite);
    if (present_is_overwrite)
      builder.append(is_overwrite);

    boolean present_hdfs_base_dir = true && (isSetHdfs_base_dir());
    builder.append(present_hdfs_base_dir);
    if (present_hdfs_base_dir)
      builder.append(hdfs_base_dir);
    ...
    builder.append(present_table_db);
    if (present_table_db)
      builder.append(table_db);

    boolean present_staging_dir = true && (isSetStaging_dir());
    builder.append(present_staging_dir);
    if (present_staging_dir)
      builder.append(staging_dir);
  ...
  public int compareTo(TFinalizeParams other) {
    ...
    lastComparison = Boolean.valueOf(isSetStaging_dir()).compareTo(typedOther.isSetStaging_dir());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStaging_dir()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.staging_dir, typedOther.staging_dir);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
