...
public class TCreateOrAlterViewParams implements org.apache.thrift.TBase<TCreateOrAlterViewParams, TCreateOrAlterViewParams._Fields>, java.io.Serializable, Cloneable {
  ...
  public com.cloudera.impala.thrift.TTableName view_name; // required
  ...
  public TCreateOrAlterViewParams(
    com.cloudera.impala.thrift.TTableName view_name,
  ...
  public TCreateOrAlterViewParams(TCreateOrAlterViewParams other) {
    ...
    if (other.isSetView_name()) {
      this.view_name = new com.cloudera.impala.thrift.TTableName(other.view_name);
    }
  ...
  public com.cloudera.impala.thrift.TTableName getView_name() {
    return this.view_name;
  }

  public TCreateOrAlterViewParams setView_name(com.cloudera.impala.thrift.TTableName view_name) {
    this.view_name = view_name;
    return this;
  }
  ...
  public TCreateOrAlterViewParams setColumns(List<com.cloudera.impala.thrift.TColumn> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VIEW_NAME:
      if (value == null) {
        ...
        setView_name((com.cloudera.impala.thrift.TTableName)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    builder.append(present_view_name);
    if (present_view_name)
      builder.append(view_name);
    ...
    builder.append(present_original_view_def);
    if (present_original_view_def)
      builder.append(original_view_def);

    boolean present_expanded_view_def = true && (isSetExpanded_view_def());
    builder.append(present_expanded_view_def);
    if (present_expanded_view_def)
      builder.append(expanded_view_def);
        ...
        switch (schemeField.id) {
          case 1: // VIEW_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.view_name = new com.cloudera.impala.thrift.TTableName();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new ArrayList<com.cloudera.impala.thrift.TColumn>(_list138.size);
                for (int _i139 = 0; _i139 < _list138.size; ++_i139)
                {
                  com.cloudera.impala.thrift.TColumn _elem140; // required
                  _elem140 = new com.cloudera.impala.thrift.TColumn();
                  _elem140.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCreateOrAlterViewParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (com.cloudera.impala.thrift.TColumn _iter141 : struct.columns)
          {
  ...
  private static class TCreateOrAlterViewParamsTupleScheme extends TupleScheme<TCreateOrAlterViewParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TCreateOrAlterViewParams struct) throws org.apache.thrift.TException {
      ...
      struct.view_name.write(oprot);
      {
        ...
        for (com.cloudera.impala.thrift.TColumn _iter142 : struct.columns)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TCreateOrAlterViewParams struct) throws org.apache.thrift.TException {
      ...
      struct.setView_nameIsSet(true);
      {
        ...
        struct.columns = new ArrayList<com.cloudera.impala.thrift.TColumn>(_list143.size);
        for (int _i144 = 0; _i144 < _list143.size; ++_i144)
        {
          com.cloudera.impala.thrift.TColumn _elem145; // required
          _elem145 = new com.cloudera.impala.thrift.TColumn();
          _elem145.read(iprot);
