...
public class TDataSourceScanNode implements org.apache.thrift.TBase<TDataSourceScanNode, TDataSourceScanNode._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>> accepted_predicates; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.ACCEPTED_PREDICATES, new org.apache.thrift.meta_data.FieldMetaData("accepted_predicates", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
                new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.cloudera.impala.extdatasource.thrift.TBinaryPredicate.class)))));
  ...
  public TDataSourceScanNode(
    ...
    String init_string,
    List<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>> accepted_predicates)
  {
    this();
  ...
  public TDataSourceScanNode(TDataSourceScanNode other) {
    ...
    if (other.isSetAccepted_predicates()) {
      List<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>> __this__accepted_predicates = new ArrayList<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>>();
      for (List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate> other_element : other.accepted_predicates) {
        List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate> __this__accepted_predicates_copy = new ArrayList<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>();
        for (com.cloudera.impala.extdatasource.thrift.TBinaryPredicate other_element_element : other_element) {
          __this__accepted_predicates_copy.add(new com.cloudera.impala.extdatasource.thrift.TBinaryPredicate(other_element_element));
        }
  ...
  public TDataSourceScanNode setData_source(com.cloudera.impala.thrift.TDataSource data_source) {
    this.data_source = data_source;
    return this;
  }
  ...
  public java.util.Iterator<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>> getAccepted_predicatesIterator() {
    return (this.accepted_predicates == null) ? null : this.accepted_predicates.iterator();
  }

  public void addToAccepted_predicates(List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate> elem) {
    if (this.accepted_predicates == null) {
      this.accepted_predicates = new ArrayList<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>>();
    }
    this.accepted_predicates.add(elem);
  }

  public List<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>> getAccepted_predicates() {
    return this.accepted_predicates;
  }

  public TDataSourceScanNode setAccepted_predicates(List<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>> accepted_predicates) {
    this.accepted_predicates = accepted_predicates;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ACCEPTED_PREDICATES:
      if (value == null) {
        ...
        setAccepted_predicates((List<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    builder.append(present_accepted_predicates);
    if (present_accepted_predicates)
      builder.append(accepted_predicates);
  ...
  public int compareTo(TDataSourceScanNode other) {
    ...
    TDataSourceScanNode typedOther = (TDataSourceScanNode)other;
    ...
    lastComparison = Boolean.valueOf(isSetAccepted_predicates()).compareTo(typedOther.isSetAccepted_predicates());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAccepted_predicates()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.accepted_predicates, typedOther.accepted_predicates);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.accepted_predicates = new ArrayList<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate> _elem2; // required
                  {
                    org.apache.thrift.protocol.TList _list3 = iprot.readListBegin();
                    _elem2 = new ArrayList<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>(_list3.size);
                    for (int _i4 = 0; _i4 < _list3.size; ++_i4)
                    {
                      com.cloudera.impala.extdatasource.thrift.TBinaryPredicate _elem5; // required
                      _elem5 = new com.cloudera.impala.extdatasource.thrift.TBinaryPredicate();
                      _elem5.read(iprot);
                      _elem2.add(_elem5);
                    }
                    iprot.readListEnd();
                  }
                  struct.accepted_predicates.add(_elem2);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDataSourceScanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.accepted_predicates != null) {
        oprot.writeFieldBegin(ACCEPTED_PREDICATES_FIELD_DESC);
        {
          ...
          for (List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate> _iter6 : struct.accepted_predicates)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter6.size()));
              for (com.cloudera.impala.extdatasource.thrift.TBinaryPredicate _iter7 : _iter6)
              {
                _iter7.write(oprot);
              }
              oprot.writeListEnd();
  ...
  private static class TDataSourceScanNodeTupleScheme extends TupleScheme<TDataSourceScanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TDataSourceScanNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.init_string);
      {
        ...
        for (List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate> _iter8 : struct.accepted_predicates)
        {
          {
            oprot.writeI32(_iter8.size());
            for (com.cloudera.impala.extdatasource.thrift.TBinaryPredicate _iter9 : _iter8)
            {
              _iter9.write(oprot);
            }
          }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDataSourceScanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setInit_stringIsSet(true);
      {
        ...
        struct.accepted_predicates = new ArrayList<List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>>(_list10.size);
        for (int _i11 = 0; _i11 < _list10.size; ++_i11)
        {
          List<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate> _elem12; // required
          {
            org.apache.thrift.protocol.TList _list13 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            _elem12 = new ArrayList<com.cloudera.impala.extdatasource.thrift.TBinaryPredicate>(_list13.size);
            for (int _i14 = 0; _i14 < _list13.size; ++_i14)
            {
              com.cloudera.impala.extdatasource.thrift.TBinaryPredicate _elem15; // required
              _elem15 = new com.cloudera.impala.extdatasource.thrift.TBinaryPredicate();
              _elem15.read(iprot);
              _elem12.add(_elem15);
            }
          }
          struct.accepted_predicates.add(_elem12);
        }
      }
      struct.setAccepted_predicatesIsSet(true);
    }
