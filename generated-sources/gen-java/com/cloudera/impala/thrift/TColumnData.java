...
public class TColumnData implements org.apache.thrift.TBase<TColumnData, TColumnData._Fields>, java.io.Serializable, Cloneable {
  ...
  public TColumnData(TColumnData other) {
    if (other.isSetIs_null()) {
      List<Boolean> __this__is_null = new ArrayList<Boolean>();
      for (Boolean other_element : other.is_null) {
        __this__is_null.add(other_element);
      }
      this.is_null = __this__is_null;
    }
    if (other.isSetBool_vals()) {
      List<Boolean> __this__bool_vals = new ArrayList<Boolean>();
      for (Boolean other_element : other.bool_vals) {
        __this__bool_vals.add(other_element);
      }
      this.bool_vals = __this__bool_vals;
    }
    if (other.isSetByte_vals()) {
      List<Byte> __this__byte_vals = new ArrayList<Byte>();
      for (Byte other_element : other.byte_vals) {
        __this__byte_vals.add(other_element);
      }
      this.byte_vals = __this__byte_vals;
    }
    if (other.isSetShort_vals()) {
      List<Short> __this__short_vals = new ArrayList<Short>();
      for (Short other_element : other.short_vals) {
        __this__short_vals.add(other_element);
      }
      this.short_vals = __this__short_vals;
    }
    if (other.isSetInt_vals()) {
      List<Integer> __this__int_vals = new ArrayList<Integer>();
      for (Integer other_element : other.int_vals) {
        __this__int_vals.add(other_element);
      }
      this.int_vals = __this__int_vals;
    }
    if (other.isSetLong_vals()) {
      List<Long> __this__long_vals = new ArrayList<Long>();
      for (Long other_element : other.long_vals) {
        __this__long_vals.add(other_element);
      }
      this.long_vals = __this__long_vals;
    }
    if (other.isSetDouble_vals()) {
      List<Double> __this__double_vals = new ArrayList<Double>();
      for (Double other_element : other.double_vals) {
        __this__double_vals.add(other_element);
      }
      this.double_vals = __this__double_vals;
    }
    if (other.isSetString_vals()) {
      List<String> __this__string_vals = new ArrayList<String>();
      for (String other_element : other.string_vals) {
        __this__string_vals.add(other_element);
      }
      this.string_vals = __this__string_vals;
    }
    if (other.isSetBinary_vals()) {
      List<ByteBuffer> __this__binary_vals = new ArrayList<ByteBuffer>();
      for (ByteBuffer other_element : other.binary_vals) {
        ByteBuffer temp_binary_element = org.apache.thrift.TBaseHelper.copyBinary(other_element);
;
        __this__binary_vals.add(temp_binary_element);
      }
  ...
  public int compareTo(TColumnData other) {
    ...
    TColumnData typedOther = (TColumnData)other;
    ...
    lastComparison = Boolean.valueOf(isSetBool_vals()).compareTo(typedOther.isSetBool_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBool_vals()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bool_vals, typedOther.bool_vals);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetByte_vals()).compareTo(typedOther.isSetByte_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetByte_vals()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.byte_vals, typedOther.byte_vals);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetShort_vals()).compareTo(typedOther.isSetShort_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShort_vals()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.short_vals, typedOther.short_vals);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetInt_vals()).compareTo(typedOther.isSetInt_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInt_vals()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.int_vals, typedOther.int_vals);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLong_vals()).compareTo(typedOther.isSetLong_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLong_vals()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.long_vals, typedOther.long_vals);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDouble_vals()).compareTo(typedOther.isSetDouble_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDouble_vals()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.double_vals, typedOther.double_vals);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetString_vals()).compareTo(typedOther.isSetString_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetString_vals()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.string_vals, typedOther.string_vals);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetBinary_vals()).compareTo(typedOther.isSetBinary_vals());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBinary_vals()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.binary_vals, typedOther.binary_vals);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  boolean _elem10; // required
                  _elem10 = iprot.readBool();
                  struct.is_null.add(_elem10);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  boolean _elem13; // required
                  _elem13 = iprot.readBool();
                  struct.bool_vals.add(_elem13);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  byte _elem16; // required
                  _elem16 = iprot.readByte();
                  struct.byte_vals.add(_elem16);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  short _elem19; // required
                  _elem19 = iprot.readI16();
                  struct.short_vals.add(_elem19);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i27 = 0; _i27 < _list26.size; ++_i27)
                {
                  ...
                  struct.double_vals.add(_elem28);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i30 = 0; _i30 < _list29.size; ++_i30)
                {
                  ...
                  struct.string_vals.add(_elem31);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                {
                  ...
                  struct.binary_vals.add(_elem34);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            boolean _elem58; // required
            _elem58 = iprot.readBool();
            struct.bool_vals.add(_elem58);
          }
        }
        struct.setBool_valsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          {
            byte _elem61; // required
            _elem61 = iprot.readByte();
            struct.byte_vals.add(_elem61);
          }
        }
        struct.setByte_valsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          {
            short _elem64; // required
            _elem64 = iprot.readI16();
            struct.short_vals.add(_elem64);
          }
        }
        struct.setShort_valsIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          {
            double _elem73; // required
            _elem73 = iprot.readDouble();
            struct.double_vals.add(_elem73);
          }
        }
        struct.setDouble_valsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          for (int _i75 = 0; _i75 < _list74.size; ++_i75)
          {
            ...
            struct.string_vals.add(_elem76);
          }
        }
        struct.setString_valsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          for (int _i78 = 0; _i78 < _list77.size; ++_i78)
          {
            ...
            struct.binary_vals.add(_elem79);
          }
        }
        struct.setBinary_valsIsSet(true);
      }
