...
public class TDdlExecResponse implements org.apache.thrift.TBase<TDdlExecResponse, TDdlExecResponse._Fields>, java.io.Serializable, Cloneable {
  ...
  public com.cloudera.impala.thrift.TResultSet result_set; // optional
  ...
  private _Fields optionals[] = {_Fields.NEW_TABLE_CREATED,_Fields.RESULT_SET};
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULT_SET, new org.apache.thrift.meta_data.FieldMetaData("result_set", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.cloudera.impala.thrift.TResultSet.class)));
  ...
  public TDdlExecResponse(TDdlExecResponse other) {
    ...
    if (other.isSetResult_set()) {
      this.result_set = new com.cloudera.impala.thrift.TResultSet(other.result_set);
    }
  }
  ...
  public com.cloudera.impala.thrift.TResultSet getResult_set() {
    return this.result_set;
  }

  public TDdlExecResponse setResult_set(com.cloudera.impala.thrift.TResultSet result_set) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULT_SET:
      if (value == null) {
        ...
        setResult_set((com.cloudera.impala.thrift.TResultSet)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    builder.append(present_new_table_created);
    if (present_new_table_created)
      builder.append(new_table_created);

    boolean present_result_set = true && (isSetResult_set());
    builder.append(present_result_set);
    if (present_result_set)
      builder.append(result_set);
  ...
  public int compareTo(TDdlExecResponse other) {
    ...
    TDdlExecResponse typedOther = (TDdlExecResponse)other;
    ...
    lastComparison = Boolean.valueOf(isSetNew_table_created()).compareTo(typedOther.isSetNew_table_created());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNew_table_created()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.new_table_created, typedOther.new_table_created);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TDdlExecResponse struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // RESULT_SET
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.result_set = new com.cloudera.impala.thrift.TResultSet();
