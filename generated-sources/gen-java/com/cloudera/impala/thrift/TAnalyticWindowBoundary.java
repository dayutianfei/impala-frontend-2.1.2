...
public class TAnalyticWindowBoundary implements org.apache.thrift.TBase<TAnalyticWindowBoundary, TAnalyticWindowBoundary._Fields>, java.io.Serializable, Cloneable {
  ...
  public com.cloudera.impala.thrift.TExpr range_offset_predicate; // optional
  ...
  private _Fields optionals[] = {_Fields.RANGE_OFFSET_PREDICATE,_Fields.ROWS_OFFSET_VALUE};
  ...
  public TAnalyticWindowBoundary(TAnalyticWindowBoundary other) {
    ...
    if (other.isSetRange_offset_predicate()) {
      this.range_offset_predicate = new com.cloudera.impala.thrift.TExpr(other.range_offset_predicate);
    }
  ...
  public com.cloudera.impala.thrift.TExpr getRange_offset_predicate() {
    return this.range_offset_predicate;
  }

  public TAnalyticWindowBoundary setRange_offset_predicate(com.cloudera.impala.thrift.TExpr range_offset_predicate) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RANGE_OFFSET_PREDICATE:
      if (value == null) {
        ...
        setRange_offset_predicate((com.cloudera.impala.thrift.TExpr)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ROWS_OFFSET_VALUE:
      return Long.valueOf(getRows_offset_value());
  ...
  public int hashCode() {
    ...
    builder.append(present_range_offset_predicate);
    if (present_range_offset_predicate)
      builder.append(range_offset_predicate);

    boolean present_rows_offset_value = true && (isSetRows_offset_value());
    builder.append(present_rows_offset_value);
    if (present_rows_offset_value)
      builder.append(rows_offset_value);
  ...
  public int compareTo(TAnalyticWindowBoundary other) {
    ...
    TAnalyticWindowBoundary typedOther = (TAnalyticWindowBoundary)other;
    ...
    lastComparison = Boolean.valueOf(isSetRange_offset_predicate()).compareTo(typedOther.isSetRange_offset_predicate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRange_offset_predicate()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.range_offset_predicate, typedOther.range_offset_predicate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRows_offset_value()).compareTo(typedOther.isSetRows_offset_value());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRows_offset_value()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.rows_offset_value, typedOther.rows_offset_value);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = TAnalyticWindowBoundaryType.findByValue(iprot.readI32());
          ...
          case 2: // RANGE_OFFSET_PREDICATE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.range_offset_predicate = new com.cloudera.impala.thrift.TExpr();
