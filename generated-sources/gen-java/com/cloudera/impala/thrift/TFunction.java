...
public class TFunction implements org.apache.thrift.TBase<TFunction, TFunction._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.COMMENT,_Fields.SIGNATURE,_Fields.HDFS_LOCATION,_Fields.SCALAR_FN,_Fields.AGGREGATE_FN};
  ...
  public TFunction(TFunction other) {
    ...
    if (other.isSetArg_types()) {
      List<TColumnType> __this__arg_types = new ArrayList<TColumnType>();
  ...
  public int hashCode() {
    ...
    builder.append(present_binary_type);
    if (present_binary_type)
      builder.append(binary_type.getValue());
    ...
    builder.append(present_ret_type);
    if (present_ret_type)
    ...
    builder.append(present_scalar_fn);
    if (present_scalar_fn)
      builder.append(scalar_fn);

    boolean present_aggregate_fn = true && (isSetAggregate_fn());
    builder.append(present_aggregate_fn);
    if (present_aggregate_fn)
      builder.append(aggregate_fn);
  ...
  public int compareTo(TFunction other) {
    ...
    TFunction typedOther = (TFunction)other;
    ...
    lastComparison = Boolean.valueOf(isSetBinary_type()).compareTo(typedOther.isSetBinary_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBinary_type()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.binary_type, typedOther.binary_type);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetRet_type()).compareTo(typedOther.isSetRet_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRet_type()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ret_type, typedOther.ret_type);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetScalar_fn()).compareTo(typedOther.isSetScalar_fn());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetScalar_fn()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.scalar_fn, typedOther.scalar_fn);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAggregate_fn()).compareTo(typedOther.isSetAggregate_fn());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAggregate_fn()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.aggregate_fn, typedOther.aggregate_fn);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  TColumnType _elem18; // required
                  _elem18 = new TColumnType();
                  _elem18.read(iprot);
                  struct.arg_types.add(_elem18);
                }
                iprot.readListEnd();
              }
  ...
  private static class TFunctionTupleScheme extends TupleScheme<TFunction> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TFunction struct) throws org.apache.thrift.TException {
      ...
      struct.setBinary_typeIsSet(true);
      {
        ...
        {
          TColumnType _elem23; // required
          _elem23 = new TColumnType();
          _elem23.read(iprot);
          struct.arg_types.add(_elem23);
        }
      }
      struct.setArg_typesIsSet(true);
      struct.ret_type = new TColumnType();
