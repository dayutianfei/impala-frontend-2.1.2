...
public class THashJoinNode implements org.apache.thrift.TBase<THashJoinNode, THashJoinNode._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.OTHER_JOIN_CONJUNCTS,_Fields.ADD_PROBE_FILTERS};
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ADD_PROBE_FILTERS:
      return Boolean.valueOf(isAdd_probe_filters());
  ...
  public int hashCode() {
    ...
    builder.append(present_join_op);
    if (present_join_op)
      builder.append(join_op.getValue());

    boolean present_eq_join_conjuncts = true && (isSetEq_join_conjuncts());
    builder.append(present_eq_join_conjuncts);
    if (present_eq_join_conjuncts)
      builder.append(eq_join_conjuncts);

    boolean present_other_join_conjuncts = true && (isSetOther_join_conjuncts());
    builder.append(present_other_join_conjuncts);
    if (present_other_join_conjuncts)
      builder.append(other_join_conjuncts);

    boolean present_add_probe_filters = true && (isSetAdd_probe_filters());
    builder.append(present_add_probe_filters);
    if (present_add_probe_filters)
      builder.append(add_probe_filters);
  ...
  public int compareTo(THashJoinNode other) {
    ...
    lastComparison = Boolean.valueOf(isSetAdd_probe_filters()).compareTo(typedOther.isSetAdd_probe_filters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAdd_probe_filters()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.add_probe_filters, typedOther.add_probe_filters);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eq_join_conjuncts = new ArrayList<TEqJoinCondition>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  TEqJoinCondition _elem26; // required
                  _elem26 = new TEqJoinCondition();
                  _elem26.read(iprot);
                  struct.eq_join_conjuncts.add(_elem26);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new ArrayList<com.cloudera.impala.thrift.TExpr>(_list27.size);
                for (int _i28 = 0; _i28 < _list27.size; ++_i28)
                {
                  com.cloudera.impala.thrift.TExpr _elem29; // required
                  _elem29 = new com.cloudera.impala.thrift.TExpr();
                  _elem29.read(iprot);
                  struct.other_join_conjuncts.add(_elem29);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.eq_join_conjuncts != null) {
        oprot.writeFieldBegin(EQ_JOIN_CONJUNCTS_FIELD_DESC);
        {
          ...
          for (TEqJoinCondition _iter30 : struct.eq_join_conjuncts)
          {
            _iter30.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOther_join_conjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (com.cloudera.impala.thrift.TExpr _iter31 : struct.other_join_conjuncts)
            {
              _iter31.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class THashJoinNodeTupleScheme extends TupleScheme<THashJoinNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.join_op.getValue());
      {
        ...
        for (TEqJoinCondition _iter32 : struct.eq_join_conjuncts)
        {
          _iter32.write(oprot);
        }
      }
      ...
      if (struct.isSetOther_join_conjuncts()) {
        {
          ...
          for (com.cloudera.impala.thrift.TExpr _iter33 : struct.other_join_conjuncts)
          {
            _iter33.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      struct.setJoin_opIsSet(true);
      {
        ...
        struct.eq_join_conjuncts = new ArrayList<TEqJoinCondition>(_list34.size);
        for (int _i35 = 0; _i35 < _list34.size; ++_i35)
        {
          TEqJoinCondition _elem36; // required
          _elem36 = new TEqJoinCondition();
          _elem36.read(iprot);
          struct.eq_join_conjuncts.add(_elem36);
        }
      }
      struct.setEq_join_conjunctsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.other_join_conjuncts = new ArrayList<com.cloudera.impala.thrift.TExpr>(_list37.size);
          for (int _i38 = 0; _i38 < _list37.size; ++_i38)
          {
            com.cloudera.impala.thrift.TExpr _elem39; // required
            _elem39 = new com.cloudera.impala.thrift.TExpr();
            _elem39.read(iprot);
            struct.other_join_conjuncts.add(_elem39);
          }
        }
        struct.setOther_join_conjunctsIsSet(true);
      }
