...
public class TAggregationNode implements org.apache.thrift.TBase<TAggregationNode, TAggregationNode._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<com.cloudera.impala.thrift.TExpr> aggregate_functions; // required
  ...
  public TAggregationNode(
    List<com.cloudera.impala.thrift.TExpr> aggregate_functions,
  ...
  public TAggregationNode(TAggregationNode other) {
    ...
    if (other.isSetAggregate_functions()) {
      List<com.cloudera.impala.thrift.TExpr> __this__aggregate_functions = new ArrayList<com.cloudera.impala.thrift.TExpr>();
      for (com.cloudera.impala.thrift.TExpr other_element : other.aggregate_functions) {
        __this__aggregate_functions.add(new com.cloudera.impala.thrift.TExpr(other_element));
      }
  ...
  public java.util.Iterator<com.cloudera.impala.thrift.TExpr> getAggregate_functionsIterator() {
    return (this.aggregate_functions == null) ? null : this.aggregate_functions.iterator();
  }

  public void addToAggregate_functions(com.cloudera.impala.thrift.TExpr elem) {
    if (this.aggregate_functions == null) {
      this.aggregate_functions = new ArrayList<com.cloudera.impala.thrift.TExpr>();
    }
    this.aggregate_functions.add(elem);
  }

  public List<com.cloudera.impala.thrift.TExpr> getAggregate_functions() {
    return this.aggregate_functions;
  }

  public TAggregationNode setAggregate_functions(List<com.cloudera.impala.thrift.TExpr> aggregate_functions) {
    this.aggregate_functions = aggregate_functions;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case AGGREGATE_FUNCTIONS:
      if (value == null) {
        ...
        setAggregate_functions((List<com.cloudera.impala.thrift.TExpr>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    builder.append(present_grouping_exprs);
    if (present_grouping_exprs)
      builder.append(grouping_exprs);

    boolean present_aggregate_functions = true && (isSetAggregate_functions());
    builder.append(present_aggregate_functions);
    if (present_aggregate_functions)
      builder.append(aggregate_functions);
    ...
    builder.append(present_need_finalize);
    if (present_need_finalize)
      builder.append(need_finalize);
  ...
  public int compareTo(TAggregationNode other) {
    ...
    lastComparison = Boolean.valueOf(isSetAggregate_functions()).compareTo(typedOther.isSetAggregate_functions());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAggregate_functions()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.aggregate_functions, typedOther.aggregate_functions);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_exprs = new ArrayList<com.cloudera.impala.thrift.TExpr>(_list40.size);
                for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                {
                  com.cloudera.impala.thrift.TExpr _elem42; // required
                  _elem42 = new com.cloudera.impala.thrift.TExpr();
                  _elem42.read(iprot);
                  struct.grouping_exprs.add(_elem42);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregate_functions = new ArrayList<com.cloudera.impala.thrift.TExpr>(_list43.size);
                for (int _i44 = 0; _i44 < _list43.size; ++_i44)
                {
                  com.cloudera.impala.thrift.TExpr _elem45; // required
                  _elem45 = new com.cloudera.impala.thrift.TExpr();
                  _elem45.read(iprot);
                  struct.aggregate_functions.add(_elem45);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.grouping_exprs != null) {
        if (struct.isSetGrouping_exprs()) {
          oprot.writeFieldBegin(GROUPING_EXPRS_FIELD_DESC);
          {
            ...
            for (com.cloudera.impala.thrift.TExpr _iter46 : struct.grouping_exprs)
            {
              _iter46.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.aggregate_functions != null) {
        oprot.writeFieldBegin(AGGREGATE_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (com.cloudera.impala.thrift.TExpr _iter47 : struct.aggregate_functions)
          {
            _iter47.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TAggregationNodeTupleScheme extends TupleScheme<TAggregationNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (com.cloudera.impala.thrift.TExpr _iter48 : struct.aggregate_functions)
        {
          _iter48.write(oprot);
        }
      }
      ...
      if (struct.isSetGrouping_exprs()) {
        {
          ...
          for (com.cloudera.impala.thrift.TExpr _iter49 : struct.grouping_exprs)
          {
            _iter49.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.aggregate_functions = new ArrayList<com.cloudera.impala.thrift.TExpr>(_list50.size);
        for (int _i51 = 0; _i51 < _list50.size; ++_i51)
        {
          com.cloudera.impala.thrift.TExpr _elem52; // required
          _elem52 = new com.cloudera.impala.thrift.TExpr();
          _elem52.read(iprot);
          struct.aggregate_functions.add(_elem52);
        }
      }
      struct.setAggregate_functionsIsSet(true);
      struct.intermediate_tuple_id = iprot.readI32();
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.grouping_exprs = new ArrayList<com.cloudera.impala.thrift.TExpr>(_list53.size);
          for (int _i54 = 0; _i54 < _list53.size; ++_i54)
          {
            com.cloudera.impala.thrift.TExpr _elem55; // required
            _elem55 = new com.cloudera.impala.thrift.TExpr();
            _elem55.read(iprot);
            struct.grouping_exprs.add(_elem55);
          }
        }
        struct.setGrouping_exprsIsSet(true);
      }
