...
public class TTransmitDataParams implements org.apache.thrift.TBase<TTransmitDataParams, TTransmitDataParams._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField SENDER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("sender_id", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  private static final int __EOS_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.DEST_FRAGMENT_INSTANCE_ID,_Fields.SENDER_ID,_Fields.DEST_NODE_ID,_Fields.ROW_BATCH,_Fields.EOS};
  ...
  public int hashCode() {
    ...
    builder.append(present_dest_fragment_instance_id);
    if (present_dest_fragment_instance_id)
      builder.append(dest_fragment_instance_id);
    ...
    builder.append(present_dest_node_id);
    if (present_dest_node_id)
      builder.append(dest_node_id);

    boolean present_row_batch = true && (isSetRow_batch());
    builder.append(present_row_batch);
    if (present_row_batch)
      builder.append(row_batch);

    boolean present_eos = true && (isSetEos());
    builder.append(present_eos);
    if (present_eos)
      builder.append(eos);
