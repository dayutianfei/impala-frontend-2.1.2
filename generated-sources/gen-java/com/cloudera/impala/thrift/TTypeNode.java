...
public class TTypeNode implements org.apache.thrift.TBase<TTypeNode, TTypeNode._Fields>, java.io.Serializable, Cloneable {
  ...
  public TTypeNode(TTypeNode other) {
    ...
    if (other.isSetStruct_fields()) {
      List<TStructField> __this__struct_fields = new ArrayList<TStructField>();
  ...
  public int hashCode() {
    ...
    builder.append(present_scalar_type);
    if (present_scalar_type)
      builder.append(scalar_type);

    boolean present_struct_fields = true && (isSetStruct_fields());
    builder.append(present_struct_fields);
    if (present_struct_fields)
      builder.append(struct_fields);
  ...
  public int compareTo(TTypeNode other) {
    ...
    TTypeNode typedOther = (TTypeNode)other;
    ...
    lastComparison = Boolean.valueOf(isSetScalar_type()).compareTo(typedOther.isSetScalar_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetScalar_type()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.scalar_type, typedOther.scalar_type);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetStruct_fields()).compareTo(typedOther.isSetStruct_fields());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStruct_fields()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.struct_fields, typedOther.struct_fields);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
