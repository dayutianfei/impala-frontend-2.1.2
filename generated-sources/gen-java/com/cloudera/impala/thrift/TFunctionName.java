...
public class TFunctionName implements org.apache.thrift.TBase<TFunctionName, TFunctionName._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TFunctionName other) {
    ...
    TFunctionName typedOther = (TFunctionName)other;
    ...
    lastComparison = Boolean.valueOf(isSetFunction_name()).compareTo(typedOther.isSetFunction_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFunction_name()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.function_name, typedOther.function_name);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
