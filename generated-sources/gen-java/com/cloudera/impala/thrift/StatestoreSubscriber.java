...
public class StatestoreSubscriber {
  ...
  public interface Iface {
    ...
    public TKeepAliveResponse KeepAlive(TKeepAliveRequest params) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void KeepAlive(TKeepAliveRequest params, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.KeepAlive_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_KeepAlive(TKeepAliveRequest params) throws org.apache.thrift.TException
    {
    ...
    public TKeepAliveResponse recv_KeepAlive() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void KeepAlive(TKeepAliveRequest params, org.apache.thrift.async.AsyncMethodCallback<KeepAlive_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      KeepAlive_call method_call = new KeepAlive_call(params, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class KeepAlive_call extends org.apache.thrift.async.TAsyncMethodCall {
      private TKeepAliveRequest params;
      public KeepAlive_call(TKeepAliveRequest params, org.apache.thrift.async.AsyncMethodCallback<KeepAlive_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.params = params;
      }
      ...
      public TKeepAliveResponse getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class KeepAlive<I extends Iface> extends org.apache.thrift.ProcessFunction<I, KeepAlive_args> {
      ...
      public KeepAlive_result getResult(I iface, KeepAlive_args args) throws org.apache.thrift.TException {
        KeepAlive_result result = new KeepAlive_result();
        result.success = iface.KeepAlive(args.params);
        return result;
      }
    }
  ...
  public static class KeepAlive_args implements org.apache.thrift.TBase<KeepAlive_args, KeepAlive_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public TKeepAliveRequest params; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.PARAMS, new org.apache.thrift.meta_data.FieldMetaData("params", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TKeepAliveRequest.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public KeepAlive_args(KeepAlive_args other) {
      if (other.isSetParams()) {
        this.params = new TKeepAliveRequest(other.params);
      }
    }
    ...
    public TKeepAliveRequest getParams() {
      return this.params;
    }

    public KeepAlive_args setParams(TKeepAliveRequest params) {
      this.params = params;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case PARAMS:
        if (value == null) {
          ...
          setParams((TKeepAliveRequest)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, KeepAlive_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // PARAMS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.params = new TKeepAliveRequest();
                struct.params.read(iprot);
                struct.setParamsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
  ...
  public static class KeepAlive_result implements org.apache.thrift.TBase<KeepAlive_result, KeepAlive_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public TKeepAliveResponse success; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TKeepAliveResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public KeepAlive_result(KeepAlive_result other) {
      if (other.isSetSuccess()) {
        this.success = new TKeepAliveResponse(other.success);
      }
    }
    ...
    public TKeepAliveResponse getSuccess() {
      return this.success;
    }

    public KeepAlive_result setSuccess(TKeepAliveResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((TKeepAliveResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, KeepAlive_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new TKeepAliveResponse();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
