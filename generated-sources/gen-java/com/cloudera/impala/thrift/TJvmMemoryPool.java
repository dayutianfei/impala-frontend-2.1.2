...
public class TJvmMemoryPool implements org.apache.thrift.TBase<TJvmMemoryPool, TJvmMemoryPool._Fields>, java.io.Serializable, Cloneable {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case PEAK_COMMITTED:
      return Long.valueOf(getPeak_committed());

    case PEAK_INIT:
      return Long.valueOf(getPeak_init());

    case PEAK_MAX:
      return Long.valueOf(getPeak_max());

    case PEAK_USED:
      return Long.valueOf(getPeak_used());
  ...
  public int hashCode() {
    ...
    builder.append(present_used);
    if (present_used)
      builder.append(used);

    boolean present_peak_committed = true;
    builder.append(present_peak_committed);
    if (present_peak_committed)
      builder.append(peak_committed);

    boolean present_peak_init = true;
    builder.append(present_peak_init);
    if (present_peak_init)
      builder.append(peak_init);

    boolean present_peak_max = true;
    builder.append(present_peak_max);
    if (present_peak_max)
      builder.append(peak_max);

    boolean present_peak_used = true;
    builder.append(present_peak_used);
    if (present_peak_used)
      builder.append(peak_used);
  ...
  public int compareTo(TJvmMemoryPool other) {
    ...
    TJvmMemoryPool typedOther = (TJvmMemoryPool)other;
    ...
    lastComparison = Boolean.valueOf(isSetPeak_committed()).compareTo(typedOther.isSetPeak_committed());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPeak_committed()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.peak_committed, typedOther.peak_committed);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPeak_init()).compareTo(typedOther.isSetPeak_init());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPeak_init()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.peak_init, typedOther.peak_init);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPeak_max()).compareTo(typedOther.isSetPeak_max());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPeak_max()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.peak_max, typedOther.peak_max);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPeak_used()).compareTo(typedOther.isSetPeak_used());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPeak_used()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.peak_used, typedOther.peak_used);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
