...
public class TTimeSeriesCounter implements org.apache.thrift.TBase<TTimeSeriesCounter, TTimeSeriesCounter._Fields>, java.io.Serializable, Cloneable {
   ...
   * @see TCounterType
   */
  public TTimeSeriesCounter setType(TCounterType type) {
    this.type = type;
    return this;
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_period_ms);
    if (present_period_ms)
      builder.append(period_ms);
  ...
  public int compareTo(TTimeSeriesCounter other) {
    ...
    TTimeSeriesCounter typedOther = (TTimeSeriesCounter)other;
    ...
    lastComparison = Boolean.valueOf(isSetPeriod_ms()).compareTo(typedOther.isSetPeriod_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPeriod_ms()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.period_ms, typedOther.period_ms);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
