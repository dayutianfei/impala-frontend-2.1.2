...
public class TPlanNodeExecSummary implements org.apache.thrift.TBase<TPlanNodeExecSummary, TPlanNodeExecSummary._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.LABEL_DETAIL,_Fields.ESTIMATED_STATS,_Fields.EXEC_STATS,_Fields.IS_ACTIVE,_Fields.IS_BROADCAST};
  ...
  public TPlanNodeExecSummary(TPlanNodeExecSummary other) {
    ...
    if (other.isSetExec_stats()) {
      List<TExecStats> __this__exec_stats = new ArrayList<TExecStats>();
    ...
    if (other.isSetIs_active()) {
      List<Boolean> __this__is_active = new ArrayList<Boolean>();
      for (Boolean other_element : other.is_active) {
        __this__is_active.add(other_element);
      }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case FRAGMENT_ID:
      return Integer.valueOf(getFragment_id());
  ...
  public int hashCode() {
    ...
    builder.append(present_fragment_id);
    if (present_fragment_id)
      builder.append(fragment_id);
  ...
  public int compareTo(TPlanNodeExecSummary other) {
    ...
    TPlanNodeExecSummary typedOther = (TPlanNodeExecSummary)other;
    ...
    lastComparison = Boolean.valueOf(isSetFragment_id()).compareTo(typedOther.isSetFragment_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFragment_id()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.fragment_id, typedOther.fragment_id);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetIs_broadcast()).compareTo(typedOther.isSetIs_broadcast());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_broadcast()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_broadcast, typedOther.is_broadcast);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  TExecStats _elem2; // required
                  _elem2 = new TExecStats();
                  _elem2.read(iprot);
                  struct.exec_stats.add(_elem2);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  boolean _elem5; // required
                  _elem5 = iprot.readBool();
                  struct.is_active.add(_elem5);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          {
            TExecStats _elem12; // required
            _elem12 = new TExecStats();
            _elem12.read(iprot);
            struct.exec_stats.add(_elem12);
          }
        }
        struct.setExec_statsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          {
            boolean _elem15; // required
            _elem15 = iprot.readBool();
            struct.is_active.add(_elem15);
          }
        }
        struct.setIs_activeIsSet(true);
      }
