...
public class TAggregateExpr implements org.apache.thrift.TBase<TAggregateExpr, TAggregateExpr._Fields>, java.io.Serializable, Cloneable {
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case IS_MERGE_AGG:
      return Boolean.valueOf(isIs_merge_agg());
  ...
  public int hashCode() {
    ...
    builder.append(present_is_merge_agg);
    if (present_is_merge_agg)
      builder.append(is_merge_agg);
  ...
  public int compareTo(TAggregateExpr other) {
    ...
    lastComparison = Boolean.valueOf(isSetIs_merge_agg()).compareTo(typedOther.isSetIs_merge_agg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_merge_agg()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_merge_agg, typedOther.is_merge_agg);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
