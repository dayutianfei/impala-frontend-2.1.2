...
public class TScalarFunction implements org.apache.thrift.TBase<TScalarFunction, TScalarFunction._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_prepare_fn_symbol);
    if (present_prepare_fn_symbol)
      builder.append(prepare_fn_symbol);

    boolean present_close_fn_symbol = true && (isSetClose_fn_symbol());
    builder.append(present_close_fn_symbol);
    if (present_close_fn_symbol)
      builder.append(close_fn_symbol);
  ...
  public int compareTo(TScalarFunction other) {
    ...
    TScalarFunction typedOther = (TScalarFunction)other;
    ...
    lastComparison = Boolean.valueOf(isSetPrepare_fn_symbol()).compareTo(typedOther.isSetPrepare_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrepare_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.prepare_fn_symbol, typedOther.prepare_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetClose_fn_symbol()).compareTo(typedOther.isSetClose_fn_symbol());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClose_fn_symbol()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.close_fn_symbol, typedOther.close_fn_symbol);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
