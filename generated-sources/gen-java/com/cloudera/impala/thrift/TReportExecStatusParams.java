...
public class TReportExecStatusParams implements org.apache.thrift.TBase<TReportExecStatusParams, TReportExecStatusParams._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_insert_exec_status = true && (isSetInsert_exec_status());
    builder.append(present_insert_exec_status);
    if (present_insert_exec_status)
      builder.append(insert_exec_status);

    boolean present_error_log = true && (isSetError_log());
    builder.append(present_error_log);
    if (present_error_log)
      builder.append(error_log);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.error_log = new ArrayList<String>(_list74.size);
                for (int _i75 = 0; _i75 < _list74.size; ++_i75)
                {
                  String _elem76; // required
                  _elem76 = iprot.readString();
                  struct.error_log.add(_elem76);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.error_log != null) {
        if (struct.isSetError_log()) {
          oprot.writeFieldBegin(ERROR_LOG_FIELD_DESC);
          {
            ...
            for (String _iter77 : struct.error_log)
            {
      ...
      if (struct.isSetError_log()) {
        {
          ...
          for (String _iter78 : struct.error_log)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.error_log = new ArrayList<String>(_list79.size);
          for (int _i80 = 0; _i80 < _list79.size; ++_i80)
          {
            String _elem81; // required
            _elem81 = iprot.readString();
            struct.error_log.add(_elem81);
          }
        }
        struct.setError_logIsSet(true);
      }
