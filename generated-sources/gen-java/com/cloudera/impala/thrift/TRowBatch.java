...
public class TRowBatch implements org.apache.thrift.TBase<TRowBatch, TRowBatch._Fields>, java.io.Serializable, Cloneable {
   ...
   */
  public com.cloudera.impala.thrift.THdfsCompression compression_type; // required
  ...
  public TRowBatch(
    ...
    String tuple_data,
    com.cloudera.impala.thrift.THdfsCompression compression_type,
   ...
   * @see com.cloudera.impala.thrift.THdfsCompression
   */
  public com.cloudera.impala.thrift.THdfsCompression getCompression_type() {
   ...
   * @see com.cloudera.impala.thrift.THdfsCompression
   */
  public TRowBatch setCompression_type(com.cloudera.impala.thrift.THdfsCompression compression_type) {
    this.compression_type = compression_type;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case COMPRESSION_TYPE:
      if (value == null) {
        ...
        setCompression_type((com.cloudera.impala.thrift.THdfsCompression)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    builder.append(present_tuple_offsets);
    if (present_tuple_offsets)
      builder.append(tuple_offsets);

    boolean present_tuple_data = true && (isSetTuple_data());
    builder.append(present_tuple_data);
    if (present_tuple_data)
      builder.append(tuple_data);

    boolean present_compression_type = true && (isSetCompression_type());
    builder.append(present_compression_type);
    if (present_compression_type)
      builder.append(compression_type.getValue());

    boolean present_uncompressed_size = true;
    builder.append(present_uncompressed_size);
    if (present_uncompressed_size)
      builder.append(uncompressed_size);
  ...
  public int compareTo(TRowBatch other) {
    ...
    lastComparison = Boolean.valueOf(isSetCompression_type()).compareTo(typedOther.isSetCompression_type());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCompression_type()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.compression_type, typedOther.compression_type);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetUncompressed_size()).compareTo(typedOther.isSetUncompressed_size());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUncompressed_size()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.uncompressed_size, typedOther.uncompressed_size);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TRowBatch struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // COMPRESSION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.compression_type = com.cloudera.impala.thrift.THdfsCompression.findByValue(iprot.readI32());
