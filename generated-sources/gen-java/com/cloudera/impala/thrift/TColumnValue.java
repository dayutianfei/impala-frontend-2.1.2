...
public class TColumnValue implements org.apache.thrift.TBase<TColumnValue, TColumnValue._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.BOOL_VAL,_Fields.BYTE_VAL,_Fields.SHORT_VAL,_Fields.INT_VAL,_Fields.LONG_VAL,_Fields.DOUBLE_VAL,_Fields.STRING_VAL,_Fields.BINARY_VAL};
...
;
  ...
  public int hashCode() {
    ...
    builder.append(present_bool_val);
    if (present_bool_val)
      builder.append(bool_val);

    boolean present_byte_val = true && (isSetByte_val());
    builder.append(present_byte_val);
    if (present_byte_val)
      builder.append(byte_val);

    boolean present_short_val = true && (isSetShort_val());
    builder.append(present_short_val);
    if (present_short_val)
      builder.append(short_val);

    boolean present_int_val = true && (isSetInt_val());
    builder.append(present_int_val);
    if (present_int_val)
      builder.append(int_val);

    boolean present_long_val = true && (isSetLong_val());
    builder.append(present_long_val);
    if (present_long_val)
      builder.append(long_val);

    boolean present_double_val = true && (isSetDouble_val());
    builder.append(present_double_val);
    if (present_double_val)
      builder.append(double_val);

    boolean present_string_val = true && (isSetString_val());
    builder.append(present_string_val);
    if (present_string_val)
      builder.append(string_val);

    boolean present_binary_val = true && (isSetBinary_val());
    builder.append(present_binary_val);
    if (present_binary_val)
      builder.append(binary_val);
  ...
  public int compareTo(TColumnValue other) {
    ...
    lastComparison = Boolean.valueOf(isSetBool_val()).compareTo(typedOther.isSetBool_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBool_val()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.bool_val, typedOther.bool_val);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetByte_val()).compareTo(typedOther.isSetByte_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetByte_val()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.byte_val, typedOther.byte_val);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetShort_val()).compareTo(typedOther.isSetShort_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShort_val()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.short_val, typedOther.short_val);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetInt_val()).compareTo(typedOther.isSetInt_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInt_val()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.int_val, typedOther.int_val);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLong_val()).compareTo(typedOther.isSetLong_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLong_val()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.long_val, typedOther.long_val);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDouble_val()).compareTo(typedOther.isSetDouble_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDouble_val()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.double_val, typedOther.double_val);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetString_val()).compareTo(typedOther.isSetString_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetString_val()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.string_val, typedOther.string_val);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetBinary_val()).compareTo(typedOther.isSetBinary_val());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBinary_val()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.binary_val, typedOther.binary_val);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
