...
public class TAlterTableParams implements org.apache.thrift.TBase<TAlterTableParams, TAlterTableParams._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.RENAME_PARAMS,_Fields.ADD_REPLACE_COLS_PARAMS,_Fields.ADD_PARTITION_PARAMS,_Fields.CHANGE_COL_PARAMS,_Fields.DROP_COL_PARAMS,_Fields.DROP_PARTITION_PARAMS,_Fields.SET_FILE_FORMAT_PARAMS,_Fields.SET_LOCATION_PARAMS,_Fields.SET_TBL_PROPERTIES_PARAMS,_Fields.UPDATE_STATS_PARAMS,_Fields.SET_CACHED_PARAMS};
  ...
  public TAlterTableParams setTable_name(com.cloudera.impala.thrift.TTableName table_name) {
    this.table_name = table_name;
    return this;
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_alter_type);
    if (present_alter_type)
      builder.append(alter_type.getValue());
    ...
    builder.append(present_rename_params);
    if (present_rename_params)
      builder.append(rename_params);

    boolean present_add_replace_cols_params = true && (isSetAdd_replace_cols_params());
    builder.append(present_add_replace_cols_params);
    if (present_add_replace_cols_params)
      builder.append(add_replace_cols_params);

    boolean present_add_partition_params = true && (isSetAdd_partition_params());
    builder.append(present_add_partition_params);
    if (present_add_partition_params)
      builder.append(add_partition_params);

    boolean present_change_col_params = true && (isSetChange_col_params());
    builder.append(present_change_col_params);
    if (present_change_col_params)
      builder.append(change_col_params);

    boolean present_drop_col_params = true && (isSetDrop_col_params());
    builder.append(present_drop_col_params);
    if (present_drop_col_params)
      builder.append(drop_col_params);

    boolean present_drop_partition_params = true && (isSetDrop_partition_params());
    builder.append(present_drop_partition_params);
    if (present_drop_partition_params)
      builder.append(drop_partition_params);

    boolean present_set_file_format_params = true && (isSetSet_file_format_params());
    builder.append(present_set_file_format_params);
    if (present_set_file_format_params)
      builder.append(set_file_format_params);

    boolean present_set_location_params = true && (isSetSet_location_params());
    builder.append(present_set_location_params);
    if (present_set_location_params)
      builder.append(set_location_params);

    boolean present_set_tbl_properties_params = true && (isSetSet_tbl_properties_params());
    builder.append(present_set_tbl_properties_params);
    if (present_set_tbl_properties_params)
      builder.append(set_tbl_properties_params);

    boolean present_update_stats_params = true && (isSetUpdate_stats_params());
    builder.append(present_update_stats_params);
    if (present_update_stats_params)
      builder.append(update_stats_params);

    boolean present_set_cached_params = true && (isSetSet_cached_params());
    builder.append(present_set_cached_params);
    if (present_set_cached_params)
      builder.append(set_cached_params);
  ...
  public int compareTo(TAlterTableParams other) {
    ...
    lastComparison = Boolean.valueOf(isSetSet_tbl_properties_params()).compareTo(typedOther.isSetSet_tbl_properties_params());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSet_tbl_properties_params()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.set_tbl_properties_params, typedOther.set_tbl_properties_params);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetUpdate_stats_params()).compareTo(typedOther.isSetUpdate_stats_params());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUpdate_stats_params()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.update_stats_params, typedOther.update_stats_params);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSet_cached_params()).compareTo(typedOther.isSetSet_cached_params());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSet_cached_params()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.set_cached_params, typedOther.set_cached_params);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
