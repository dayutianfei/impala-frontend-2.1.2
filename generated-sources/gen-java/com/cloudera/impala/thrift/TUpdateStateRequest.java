...
public class TUpdateStateRequest implements org.apache.thrift.TBase<TUpdateStateRequest, TUpdateStateRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  public TUpdateStateRequest setRegistration_id(com.cloudera.impala.thrift.TUniqueId registration_id) {
  ...
  public int hashCode() {
    ...
    builder.append(present_topic_deltas);
    if (present_topic_deltas)
      builder.append(topic_deltas);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i25 = 0; _i25 < _map24.size; ++_i25)
                {
                  ...
                  TTopicDelta _val27; // required
                  _key26 = iprot.readString();
                  _val27 = new TTopicDelta();
                  _val27.read(iprot);
                  struct.topic_deltas.put(_key26, _val27);
                }
                iprot.readMapEnd();
              }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TUpdateStateRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setProtocol_versionIsSet(true);
      {
        ...
        for (int _i31 = 0; _i31 < _map30.size; ++_i31)
        {
          ...
          TTopicDelta _val33; // required
          _key32 = iprot.readString();
          _val33 = new TTopicDelta();
          _val33.read(iprot);
          struct.topic_deltas.put(_key32, _val33);
        }
      }
      struct.setTopic_deltasIsSet(true);
