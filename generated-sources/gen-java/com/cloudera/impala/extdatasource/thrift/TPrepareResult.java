...
public class TPrepareResult implements org.apache.thrift.TBase<TPrepareResult, TPrepareResult._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<Integer> accepted_conjuncts; // optional
  ...
  private _Fields optionals[] = {_Fields.NUM_ROWS_ESTIMATE,_Fields.ACCEPTED_CONJUNCTS};
  ...
  public TPrepareResult(TPrepareResult other) {
    ...
    if (other.isSetAccepted_conjuncts()) {
      List<Integer> __this__accepted_conjuncts = new ArrayList<Integer>();
      for (Integer other_element : other.accepted_conjuncts) {
        __this__accepted_conjuncts.add(other_element);
      }
  ...
  public TPrepareResult setStatus(com.cloudera.impala.thrift.TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public TPrepareResult setNum_rows_estimate(long num_rows_estimate) {
  ...
  public TPrepareResult setAccepted_conjuncts(List<Integer> accepted_conjuncts) {
  ...
  public int hashCode() {
    ...
    builder.append(present_num_rows_estimate);
    if (present_num_rows_estimate)
      builder.append(num_rows_estimate);

    boolean present_accepted_conjuncts = true && (isSetAccepted_conjuncts());
    builder.append(present_accepted_conjuncts);
    if (present_accepted_conjuncts)
      builder.append(accepted_conjuncts);
  ...
  public int compareTo(TPrepareResult other) {
    ...
    TPrepareResult typedOther = (TPrepareResult)other;
    ...
    lastComparison = Boolean.valueOf(isSetNum_rows_estimate()).compareTo(typedOther.isSetNum_rows_estimate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNum_rows_estimate()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.num_rows_estimate, typedOther.num_rows_estimate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetAccepted_conjuncts()).compareTo(typedOther.isSetAccepted_conjuncts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAccepted_conjuncts()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.accepted_conjuncts, typedOther.accepted_conjuncts);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i33 = 0; _i33 < _list32.size; ++_i33)
                {
                  ...
                  struct.accepted_conjuncts.add(_elem34);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          for (int _i38 = 0; _i38 < _list37.size; ++_i38)
          {
            ...
            struct.accepted_conjuncts.add(_elem39);
          }
        }
        struct.setAccepted_conjunctsIsSet(true);
      }
