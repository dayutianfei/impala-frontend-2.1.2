...
public class TRowBatch implements org.apache.thrift.TBase<TRowBatch, TRowBatch._Fields>, java.io.Serializable, Cloneable {
  ...
  public TRowBatch(TRowBatch other) {
    ...
    if (other.isSetCols()) {
      List<com.cloudera.impala.thrift.TColumnData> __this__cols = new ArrayList<com.cloudera.impala.thrift.TColumnData>();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  com.cloudera.impala.thrift.TColumnData _elem10; // required
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            com.cloudera.impala.thrift.TColumnData _elem15; // required
