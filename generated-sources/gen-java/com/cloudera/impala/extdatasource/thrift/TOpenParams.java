...
public class TOpenParams implements org.apache.thrift.TBase<TOpenParams, TOpenParams._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.QUERY_ID,_Fields.TABLE_NAME,_Fields.INIT_STRING,_Fields.AUTHENTICATED_USER_NAME,_Fields.ROW_SCHEMA,_Fields.BATCH_SIZE,_Fields.PREDICATES,_Fields.LIMIT};
  ...
  public TOpenParams setLimit(long limit) {
    this.limit = limit;
    setLimitIsSet(true);
    return this;
  }
  ...
  public int hashCode() {
    ...
    builder.append(present_authenticated_user_name);
    if (present_authenticated_user_name)
      builder.append(authenticated_user_name);

    boolean present_row_schema = true && (isSetRow_schema());
    builder.append(present_row_schema);
    if (present_row_schema)
      builder.append(row_schema);
  ...
  public int compareTo(TOpenParams other) {
    ...
    TOpenParams typedOther = (TOpenParams)other;
    ...
    lastComparison = Boolean.valueOf(isSetAuthenticated_user_name()).compareTo(typedOther.isSetAuthenticated_user_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAuthenticated_user_name()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.authenticated_user_name, typedOther.authenticated_user_name);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRow_schema()).compareTo(typedOther.isSetRow_schema());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRow_schema()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.row_schema, typedOther.row_schema);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  List<TBinaryPredicate> _elem42; // required
                  {
                    org.apache.thrift.protocol.TList _list43 = iprot.readListBegin();
                    _elem42 = new ArrayList<TBinaryPredicate>(_list43.size);
                    for (int _i44 = 0; _i44 < _list43.size; ++_i44)
                    {
                      TBinaryPredicate _elem45; // required
                      _elem45 = new TBinaryPredicate();
                      _elem45.read(iprot);
                      _elem42.add(_elem45);
                    }
                    iprot.readListEnd();
                  }
                  struct.predicates.add(_elem42);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(6)) {
        {
          ...
          {
            List<TBinaryPredicate> _elem52; // required
            {
              org.apache.thrift.protocol.TList _list53 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
              _elem52 = new ArrayList<TBinaryPredicate>(_list53.size);
              for (int _i54 = 0; _i54 < _list53.size; ++_i54)
              {
                TBinaryPredicate _elem55; // required
                _elem55 = new TBinaryPredicate();
                _elem55.read(iprot);
                _elem52.add(_elem55);
              }
            }
            struct.predicates.add(_elem52);
          }
        }
        struct.setPredicatesIsSet(true);
      }
