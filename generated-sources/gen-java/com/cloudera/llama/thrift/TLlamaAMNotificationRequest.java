...
public class TLlamaAMNotificationRequest implements org.apache.thrift.TBase<TLlamaAMNotificationRequest, TLlamaAMNotificationRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_heartbeat);
    if (present_heartbeat)
      builder.append(heartbeat);

    boolean present_allocated_reservation_ids = true && (isSetAllocated_reservation_ids());
    builder.append(present_allocated_reservation_ids);
    if (present_allocated_reservation_ids)
      builder.append(allocated_reservation_ids);
    ...
    boolean present_rejected_reservation_ids = true && (isSetRejected_reservation_ids());
    builder.append(present_rejected_reservation_ids);
    if (present_rejected_reservation_ids)
      builder.append(rejected_reservation_ids);

    boolean present_rejected_client_resource_ids = true && (isSetRejected_client_resource_ids());
    builder.append(present_rejected_client_resource_ids);
    if (present_rejected_client_resource_ids)
      builder.append(rejected_client_resource_ids);

    boolean present_lost_client_resource_ids = true && (isSetLost_client_resource_ids());
    builder.append(present_lost_client_resource_ids);
    if (present_lost_client_resource_ids)
      builder.append(lost_client_resource_ids);

    boolean present_preempted_reservation_ids = true && (isSetPreempted_reservation_ids());
    builder.append(present_preempted_reservation_ids);
    if (present_preempted_reservation_ids)
      builder.append(preempted_reservation_ids);

    boolean present_preempted_client_resource_ids = true && (isSetPreempted_client_resource_ids());
    builder.append(present_preempted_client_resource_ids);
    if (present_preempted_client_resource_ids)
      builder.append(preempted_client_resource_ids);

    boolean present_admin_released_reservation_ids = true && (isSetAdmin_released_reservation_ids());
    builder.append(present_admin_released_reservation_ids);
    if (present_admin_released_reservation_ids)
      builder.append(admin_released_reservation_ids);

    boolean present_lost_reservation_ids = true && (isSetLost_reservation_ids());
    builder.append(present_lost_reservation_ids);
    if (present_lost_reservation_ids)
      builder.append(lost_reservation_ids);
