...
public class TLlamaAMAdminReleaseRequest implements org.apache.thrift.TBase<TLlamaAMAdminReleaseRequest, TLlamaAMAdminReleaseRequest._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_do_not_cache);
    if (present_do_not_cache)
      builder.append(do_not_cache);
    ...
    boolean present_handles = true && (isSetHandles());
    builder.append(present_handles);
    if (present_handles)
      builder.append(handles);

    boolean present_reservations = true && (isSetReservations());
    builder.append(present_reservations);
    if (present_reservations)
