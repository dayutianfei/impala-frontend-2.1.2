...
public class TNodeCapacity implements org.apache.thrift.TBase<TNodeCapacity, TNodeCapacity._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_total_v_cpu_cores = true;
    builder.append(present_total_v_cpu_cores);
    if (present_total_v_cpu_cores)
      builder.append(total_v_cpu_cores);

    boolean present_total_memory_mb = true;
    builder.append(present_total_memory_mb);
    if (present_total_memory_mb)
      builder.append(total_memory_mb);

    boolean present_free_v_cpu_cores = true;
    builder.append(present_free_v_cpu_cores);
    if (present_free_v_cpu_cores)
      builder.append(free_v_cpu_cores);

    boolean present_free_memory_mb = true;
    builder.append(present_free_memory_mb);
    if (present_free_memory_mb)
      builder.append(free_memory_mb);
