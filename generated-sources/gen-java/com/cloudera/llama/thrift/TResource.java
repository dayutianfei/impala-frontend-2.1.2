...
public class TResource implements org.apache.thrift.TBase<TResource, TResource._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    boolean present_client_resource_id = true && (isSetClient_resource_id());
    builder.append(present_client_resource_id);
    if (present_client_resource_id)
      builder.append(client_resource_id);

    boolean present_v_cpu_cores = true;
    builder.append(present_v_cpu_cores);
    if (present_v_cpu_cores)
      builder.append(v_cpu_cores);

    boolean present_memory_mb = true;
    builder.append(present_memory_mb);
    if (present_memory_mb)
      builder.append(memory_mb);

    boolean present_askedLocation = true && (isSetAskedLocation());
    builder.append(present_askedLocation);
    if (present_askedLocation)
      builder.append(askedLocation);

    boolean present_enforcement = true && (isSetEnforcement());
    builder.append(present_enforcement);
    if (present_enforcement)
      builder.append(enforcement.getValue());
