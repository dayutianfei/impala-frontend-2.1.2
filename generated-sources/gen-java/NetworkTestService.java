...
public class NetworkTestService {
  ...
  public interface Iface {
    ...
    public ThriftDataResult Send(ThriftDataParams params) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void Send(ThriftDataParams params, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.Send_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_Send(ThriftDataParams params) throws org.apache.thrift.TException
    {
    ...
    public ThriftDataResult recv_Send() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class Send_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public ThriftDataResult getResult() throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class Send<I extends Iface> extends org.apache.thrift.ProcessFunction<I, Send_args> {
      ...
      public Send_result getResult(I iface, Send_args args) throws org.apache.thrift.TException {
        Send_result result = new Send_result();
        result.success = iface.Send(args.params);
        return result;
      }
    }
  ...
  public static class Send_args implements org.apache.thrift.TBase<Send_args, Send_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public ThriftDataParams params; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.PARAMS, new org.apache.thrift.meta_data.FieldMetaData("params", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ThriftDataParams.class)));
    ...
    public Send_args(Send_args other) {
      if (other.isSetParams()) {
        this.params = new ThriftDataParams(other.params);
      }
    }
    ...
    public ThriftDataParams getParams() {
      return this.params;
    }

    public Send_args setParams(ThriftDataParams params) {
      this.params = params;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case PARAMS:
        if (value == null) {
          ...
          setParams((ThriftDataParams)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // PARAMS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.params = new ThriftDataParams();
  ...
  public static class Send_result implements org.apache.thrift.TBase<Send_result, Send_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public ThriftDataResult success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ThriftDataResult.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public Send_result(Send_result other) {
      if (other.isSetSuccess()) {
        this.success = new ThriftDataResult(other.success);
      }
    }
    ...
    public ThriftDataResult getSuccess() {
      return this.success;
    }

    public Send_result setSuccess(ThriftDataResult success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((ThriftDataResult)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, Send_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new ThriftDataResult();
